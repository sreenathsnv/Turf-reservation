...
urlpatterns = [
    ...
    path('api/player/<int:player_id>/performance-metrics-over-time/', performance_metrics_over_time, name='performance_metrics_over_time'),
    path('api/player/<int:player_id>/overall-performance-rating/', overall_performance_rating, name='overall_performance_rating'),
    path('api/player/<int:player_id>/skill-radar-chart/', player_skill_radar_chart, name='player_skill_radar_chart'),
]
